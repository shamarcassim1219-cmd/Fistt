          ...
          child: ListView(
            ...
            children: [
              Container(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.support_agent_outlined, color: AppColors.primary, size: 22),
                    SizedBox(width: 10),
                    Expanded(
                      child: Text(
                        'Send a message directly to our admin team. We typically respond within 24 hours.',
              ...
              const Text('Category', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 13)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _submitting
                      ...
                      : const Text('Send to Admin', style: TextStyle(fontWeight: FontWeight.bold)),
                ),
              ),
