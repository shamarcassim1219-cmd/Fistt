...
class _AddListingScreenState extends State<AddListingScreen> {
  ...
  Future<List<String>> _uploadScreenshots() async {
    ...
    for (final file in _screenshots) {
      final url = await CloudinaryService.uploadImage(file, folder: 'listings');
      urls.add(url);
    }
    return urls;
  }
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'These details are stored securely and only shown to the buyer after payment is confirmed.',
