...
class SimpleImageCropper extends StatefulWidget {
  ...
  const SimpleImageCropper({super.key, required this.bytes});
...
class _SimpleImageCropperState extends State<SimpleImageCropper> {
  ...
  Future<void> _done() async {
    ...
    try {
      ...
      const target = 900.0;
      final pixelRatio = renderObject.size.width > 0 ? target / renderObject.size.width : 1.0;
      ...
      body: Column(
        children: [
          const Padding(
            ...
            child: Text(
              'Pinch to zoom and drag to position your photo inside the square.',
